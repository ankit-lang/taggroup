  ...
  ({
    ...
    >
      <span
        ...
        style={{ transform: FRONT_FACE_TRANSFORMS[rotateDirection], backfaceVisibility: 'hidden' }}
      >
        {char}
      </span>
      <span
        ...
        style={{ transform: SECOND_FACE_TRANSFORMS[rotateDirection], backfaceVisibility: 'hidden' }}
      >
        {char}
      </span>
    </span>
